var app = angular.module('Grammarbuffet', [
  'ngResource',
  'ngRoute',
  'monospaced.elastic',
  'angular-growl',
...
app.controller('EasyFictionCtrl', [
  '$scope',
  '$location',
  '$routeParams',
  'growl',
  ...
  function($scope, $location, $routeParams, growl, StoryList, $sce, ModalService) {
    ...
    $scope.getHint = function() {
      ...
      growl.warning('...look near the HIGHLIGHT marks', {
        title: "We're still missing " + differenceCount + ' things'
      });

      setTimeout(function() {
        $scope.story_highlights = $scope.originalHighlights;
      }, 8000);
    };
...
app.controller('RegularFictionCtrl', [
  '$scope',
  '$resource',
  '$location',
  '$routeParams',
  ...
  function($scope, $resource, $location, $routeParams, growl, StoryList, $sce) {
    ...
    $scope.getHint = function() {
      ...
      growl.warning('...look near the singular countable nouns', {
        title:
          'We have ' +
          countA(amendedArray) +
          " A's, and we need " +
          ...
          '...' +
          'we have ' +
          countAn(amendedArray) +
          " An's, and we need " +
          countAn(storyArray) +
          '...' +
          'we have ' +
          countThe(amendedArray) +
          " The's, and we need " +
          countThe(storyArray)
      });
    };
...
app.controller('EasyAcademicCtrl', [
  '$scope',
  '$location',
  '$routeParams',
  'growl',
  ...
  function($scope, $location, $routeParams, growl, $sce) {
    ...
    $scope.getHint = function() {
      ...
      setTimeout(function() {
        $scope.summary_highlights = $scope.originalHighlights;
      }, 8000);
    };
  }
]);

app.controller('RegularAcademicCtrl', [
  '$scope',
  '$resource',
  '$location',
  '$routeParams',
    ...
    $scope.getHint = function() {
      ...
      growl.warning('...look near the singular countable nouns', {
        title:
          ...
          countAn(amendedArray) +
          " An's, and we need " +
          countAn(summaryArray) +
          '...' +
          'we have ' +
          countThe(amendedArray) +
          " The's, and we need " +
          countThe(summaryArray)
      });
    };
  }
]);
...
app.controller('EasyBusinessCtrl', [
  '$scope',
  '$location',
  '$routeParams',
  'growl',
  ...
  function($scope, $location, $routeParams, growl, Article, $sce) {
    ...
    $scope.getHint = function() {
      ...
      setTimeout(function() {
        $scope.article_highlights = $scope.originalHighlights;
      }, 8000);
    };
  }
]);

app.controller('RegularBusinessCtrl', [
  '$scope',
  '$resource',
  '$location',
  '$routeParams',
    ...
    $scope.getHint = function() {
      ...
      growl.warning('...look near the singular countable nouns', {
        title:
          ...
          countAn(amendedArray) +
          " An's, and we need " +
          countAn(articleArray) +
          '...' +
          'we have ' +
          countThe(amendedArray) +
          " The's, and we need " +
          countThe(articleArray)
      });
    };
  }
]);
